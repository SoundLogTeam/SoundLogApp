...
const privacySections = [
  {
    title: '수집하는 정보',
    body: 'Soundlog는 계정 연동 시 소셜 로그인 제공자가 전달하는 식별자, 이름, 이메일을 저장할 수 있습니다. 사용자가 입력한 음악 취향, 여행 스타일, 동행 유형, 좋아요와 저장한 음악, 여행 순간 기록, Recap 생성에 필요한 사진, 위치, 시간, 장소, 음악 정보를 저장할 수 있습니다.',
  },
  {
    title: '위치와 사진 권한',
  ...
  {
    title: '제3자 서비스',
    body: '로그인에는 Apple, Kakao 계정 제공자가 사용될 수 있고, 장소 정보에는 공공 관광 데이터 API가 사용될 수 있습니다. 외부 음악 앱으로 이동하는 경우 해당 서비스의 개인정보 처리방침이 적용됩니다.',
  },
  {
    title: '보관과 삭제',
