...
const privacySections = [
  {
    title: "수집하는 정보",
    body: "Soundlog는 이메일 계정 가입과 로그인을 위해 사용자가 입력한 이름, 이메일, 비밀번호 인증 정보를 처리할 수 있습니다. 사용자가 입력한 음악 취향, 여행 스타일, 동행 유형, 좋아요와 저장한 음악, 리캡과 여행 로그 생성에 필요한 사진, 위치, 시간, 장소, 음악 정보를 저장할 수 있습니다.",
  },
  {
    title: "위치와 사진 권한",
  ...
  {
    title: "제3자 서비스",
    body: "로그인에는 이메일 계정이 사용되고, 장소 정보에는 공공 관광 데이터 API가 사용될 수 있습니다. Soundlog는 음악 추천과 기록 UI를 앱 안에서 제공하며, 음원 재생 서비스 계정 정보는 수집하지 않습니다.",
  },
  {
    title: "보관과 삭제",
    body: "계정 데이터와 여행 기록은 사용자가 서비스를 이용하는 동안 보관됩니다. My 화면의 계정 삭제를 실행하면 계정, 인증 토큰, 여행 기록, 리캡, 보관함과 커뮤니티 데이터가 즉시 삭제됩니다. 삭제 후에는 복구할 수 없습니다.",
  },
  {
    title: "문의",
