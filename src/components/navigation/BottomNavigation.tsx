...
function CameraTabButton({ accessibilityState }: CameraTabButtonProps) {
  return (
    <View className="flex-1 items-center" pointerEvents="box-none">
      <Pressable
        accessibilityLabel="카메라로 리캡 만들기"
  ...
  return (
    ...
    >
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <TabIcon color={String(color)} name="map" />
          ),
          title: "지도",
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <TabIcon color={String(color)} name="music" />
          ),
          title: "음악추천",
        }}
      />
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <TabIcon color={String(color)} name="disc" />
          ),
          title: "로그",
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <TabIcon color={String(color)} name="user" />
          ),
          title: "마이",
        }}
      />
