...
export const moodRecommendations: MoodRecommendation[] = [
  {
    ...
    color: '#2B176C',
    genres: ['인디', '발라드'],
    imageUrl: getPublicImageUrl('chuncheon'),
    moods: ['잔잔한', '감성적인'],
  ...
  },
  {
    ...
    color: '#B1913A',
    genres: ['팝', 'K-POP'],
    imageUrl: getPublicImageUrl('geoje'),
    moods: ['신나는', '시원한', '활기찬'],
    playlistId: 'drive',
  ...
  },
  {
    ...
    color: '#3F2C6B',
    genres: ['인디', 'R&B'],
    imageUrl: getPublicImageUrl('jeonju'),
    moods: ['잔잔한', '시원한'],
...
export const recentMusicLogs: MusicLogItem[] = [
  ...
  },
  {
    ...
    id: 'log-4',
    imageUrl: getPublicImageUrl('jeju'),
    placeName: '제주 애월',
    recapShareId: 'log-1',
    trackTitle: 'seasons',
  },
  {
    ...
    id: 'log-5',
    imageUrl: getPublicImageUrl('gyeongju'),
    placeName: '경주',
    recapShareId: 'log-2',
    trackTitle: 'Dinosaur',
  },
